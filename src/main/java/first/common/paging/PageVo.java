...
public class PageVo {
    ...
    private int startPageNoMysql; // mysql 쿼리조회용 limit 시작 페이지 번호
    ...
    private void makePaging() {
        ...
        this.setStartPageNoMysql((pageNo - 1) * 10);
	...
	public int getStartPageNoMysql() {
		return startPageNoMysql;
	}

	public void setStartPageNoMysql(int startPageNoMysql) {
		this.startPageNoMysql = startPageNoMysql;
	}
}