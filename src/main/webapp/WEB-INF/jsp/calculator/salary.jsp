				...
				<div class="col-lg-8">
						...
						<form class="form-horizontal style-form" method="get">
							<div class="form-group">
								<label class="col-sm-3 col-sm-3 control-label">연봉/월급 선택</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label class="col-sm-3 col-sm-3 control-label">퇴직금</label>
								<div class="col-sm-4">
									<div class="radio-inline">
									  <label>
							...
							<div class="form-group">
								<label class="col-sm-3 col-sm-3 control-label">연봉</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label class="col-sm-3 col-sm-3 control-label">부양가족수</label>
								<div class="col-sm-4">
							...
							<div class="form-group">
								<label class="col-sm-3 col-sm-3 control-label">20세이하 자녀수</label>
								<div class="col-sm-4">
